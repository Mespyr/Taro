...
$(BIN): $(OBJ_FILES) $(LEXER_OBJ_FILES) $(PARSER_OBJ_FILES) $(TYPE_CHECKER_OBJ_FILES) $(OBJ_DIR)
	$(CPP) $(OBJ_FILES) $(LEXER_OBJ_FILES) $(PARSER_OBJ_FILES) $(TYPE_CHECKER_OBJ_FILES) -o $@ $(LDFLAGS)
